  ...
  it: [
    ...
    },
    {
      ...
      items: [
        ...
        'Documentazione tecnica, di collaudo e di conformità DNSH (PA / progetti a finanziamento pubblico)',
      ],
    },
  ],
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        'Technical, acceptance and DNSH-compliance documentation (public sector / publicly funded projects)',
      ],
    },
  ],
};
